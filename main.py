...
if __name__ == "__main__":
    ...
    parser.add_argument('--testdir', help='Path to test images')
    parser.add_argument('--savedir', help='Path to save upscaled images')
    ...
    if args.upscale:
        ...
        img_list = os.listdir(args.testdir)
        for img in img_list:
            img_path = os.path.join(args.testdir, img)
            run.upscale(img_path, args.savedir)
